...
<div id="genel">
	...
	<div id="orta">
		...
		<div class="hak">
			<center><h1>
				Geçmişten Geleceğe Moda Sitesi - Hakkımızda
			</h1></center>
			<p> 
				***Yeni Duyuru: Sİtemiz yayın hayatına başlamıştır! <br />
			</p>
			<b> ***Yeni Duyuru: Resim galerisi üyelerimizin hizmetine açılmıştır.</b>
			<p> ***Bizlere iletişim bilgilerinizden 7/24 ulaşabilirsiniz!				
			</p>
		</div>
	</div>
<!-- genel div son-->
